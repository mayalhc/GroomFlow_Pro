...
* **수정된 문제**
  ...
  * **Clump Start가 이름대로 동작합니다** — 클럼핑이 *시작*되는 지점. 이전에는 그 지점 *이전에* 클럼프를 최대까지 올려서, 값이 작으면 변화 전체가 첫 한두 구간에 압축됐습니다.
  ...
  * 최소 지원 Blender 버전이 **4.5 LTS**가 되었습니다. 4.5 LTS, 5.0, 5.2 LTS, 5.3에서 검증했습니다.
